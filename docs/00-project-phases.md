...
| 2 | Data model & local storage | How are publications, versions, evidence and decisions represented on disk? | [02-data-model.md](02-data-model.md) | **Draft 2** — decisions S1–S8 agreed; awaiting review |
